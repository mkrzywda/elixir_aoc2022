defmodule ParserBlizzardBasin do
  def parse(data) do
    data
    |> String.trim()
    |> String.split(~r/\R/)
...
defmodule SolverParserBlizzardBasin do
  def solvePartA(data) do
    {map, blizzards} = data
    |> ParserBlizzardBasin.parse()
...
defmodule AdventOfCode.Day24 do
  def part1(args) do
    args
    |> SolverParserBlizzardBasin.solvePartA()
  end


  def part2(args) do
    args
    |> SolverParserBlizzardBasin.solvePartB()
  end
end
